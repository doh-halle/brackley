defmodule BrackleyWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use BrackleyWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import BrackleyWeb.ConnCase
    end
  end

  setup tags do
    Brackley.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_administrator(%{conn: conn}) do
    administrator = Brackley.AdministrationFixtures.administrator_fixture()
  ...
  def log_in_administrator(conn, administrator) do
    token = Brackley.Administration.generate_administrator_session_token(administrator)
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Brackley.AccountFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Brackley.Account.generate_user_session_token(user)
